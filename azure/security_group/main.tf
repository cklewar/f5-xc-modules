resource "azurerm_network_security_group" "sg" {
  ...
  dynamic "security_rule" {
    ...
    content {
      ...
      source_address_prefix      = optional(security_rule.value.source_address_prefix)
      destination_address_prefix = optional(security_rule.value.destination_address_prefix)
    }
  }
