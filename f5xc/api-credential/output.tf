...
output "api_credential" {
  value = {
    ...
    "k8s_conf"              = var.f5xc_api_credential_type == var.f5xc_api_credential_type_kube_config && length(data.local_file.response) > 0 ? base64decode(jsondecode(data.local_file.response[0].content).data) : null
