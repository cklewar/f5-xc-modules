...
module "node" {
  ...
  instance_name               = var.instance_name
  sli_subnetwork              = var.fabric_subnet_inside != "" ? module.network.ce[0]["sli_subnetwork"] : var.existing_fabric_subnet_inside
  slo_subnetwork              = var.fabric_subnet_outside != "" ? module.network.ce[0]["slo_subnetwork"] : var.existing_fabric_subnet_outside
  ssh_public_key              = var.ssh_public_key
