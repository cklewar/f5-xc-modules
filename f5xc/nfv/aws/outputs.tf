output "nfv" {
  value = {
    ...
    nodes                    = {
      ...
      node1_external_interface_ip = var.f5xc_nfv_type == var.f5xc_nfv_type_f5_big_ip_aws_service ? {
      ...
      node1_internal_interface_ip = var.f5xc_nfv_type == var.f5xc_nfv_type_f5_big_ip_aws_service ? {
