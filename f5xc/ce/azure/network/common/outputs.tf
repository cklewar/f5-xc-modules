output "common" {
  value = {
    ...
    sg_slo_secure_ce = var.f5xc_is_secure_cloud_ce ? module.sg_slo_secure_ce : null
    sg_sli_secure_ce = var.is_multi_nic &&  var.f5xc_is_secure_cloud_ce ? module.sg_sli_secure_ce : null
