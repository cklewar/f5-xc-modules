locals {
  ...
  f5xc_azure_vnet_name           = var.f5xc_azure_vnet_name != "" ? var.f5xc_azure_vnet_name : format("%s-vnet", var.f5xc_azure_site_name)
  f5xc_azure_vnet_resource_group = var.f5xc_azure_vnet_resource_group != "" ? var.f5xc_azure_vnet_resource_group : format("%s-rg", var.f5xc_azure_site_name)
}