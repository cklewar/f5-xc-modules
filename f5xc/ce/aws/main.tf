...
module "network" {
  ...
  aws_security_group_rule_sli_ingress = var.security_group_rule_sli_ingress
  aws_security_group_rule_slo_egress  = var.security_group_rule_slo_egress
  aws_security_group_rule_slo_ingress = var.security_group_rule_slo_ingress
}
